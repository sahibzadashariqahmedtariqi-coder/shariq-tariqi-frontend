...
// PDFs now work directly since Cloudinary PDF delivery is enabled
                      ...
                      <div className="p-4">
                        ...
                        {product.pdfUrl && (
                          <div className="flex gap-2">
                            ...
                            <button
                              onClick={() => handleDownloadPdf(getPdfUrl(product.pdfUrl!), product.name)}
