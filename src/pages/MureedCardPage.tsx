        ...
        <div style="width: 800px; min-width: 800px; background: linear-gradient(to bottom right, #fefefe, #f8f6f0, #f0ebe0); position: relative; overflow: hidden; font-family: system-ui, -apple-system, sans-serif;">
          ...
          <div style="padding: 40px; position: relative; z-index: 10;">
            ...
            <div style="margin-top: 32px; padding-top: 24px; border-top: 2px solid #1B4332; display: flex; justify-content: space-between; align-items: center;">
              <div>
                <p style="font-size: 14px; color: #1B4332; margin: 0; font-family: 'Noto Nastaliq Urdu', serif;">ہر اسلامی ماہ کی سترھویں تاریخ کو مرکزی خانقاہ طارقی جہانگیری سرجانی ٹاؤن میں میاں حضور اور صاحبزادہ و خلیفہ حکیم شارق احمد طارقی کے زیرِ اہتمام ختمِ خواجگان کا باقاعدہ اہتمام کیا جاتا ہے۔</p>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
                    <div className="text-center md:text-left">
                      <p className="text-xs md:text-sm text-primary-700 font-arabic leading-relaxed">
                        ہر اسلامی ماہ کی سترھویں تاریخ کو مرکزی خانقاہ طارقی جہانگیری سرجانی ٹاؤن میں میاں حضور اور صاحبزادہ و خلیفہ حکیم شارق احمد طارقی کے زیرِ اہتمام ختمِ خواجگان کا باقاعدہ اہتمام کیا جاتا ہے۔
                      </p>
