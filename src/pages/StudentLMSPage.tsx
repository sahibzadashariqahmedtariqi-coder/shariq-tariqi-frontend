                    ...
                    >
                      <div className="relative w-56 h-56">
                        ...
                        <div className="absolute inset-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center">
                          <img src="https://res.cloudinary.com/du7qzhimu/image/upload/v1771502643/shariq-website/products/tarv5nl0paqk3nehw7ou.png" alt="Logo" className="w-28 h-28 object-contain" />
                        </div>
                      </div>
                    </motion.div>
                  </div>
